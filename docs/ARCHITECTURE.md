...
Gradle runs on JDK 21 and compiles to a Java 17 bytecode target in every module. Toolchain
auto-provisioning is not used, so local (JBR 21) and CI (Temurin 21) behave the same.
